...
description: Style rules for PR PRD pages in the "PR PRD" Notion database. Applies when creating, appending to, or iterating on these pages from the agent. Terse, demo-first, no design rationale.
---
